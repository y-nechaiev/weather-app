...
const UnitsToggle = ({ units, onUnitsChange }) => {
  ...
  return (
    <div className="m-auto mt-4 w-full md:w-3/5 lg:w-1/2">
      <button
        type="button"
        className="rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-green-200 focus:ring-offset-2 focus:ring-offset-gray-500"
        id="toggle-units"
        aria-expanded="false"
        aria-haspopup="true"
      ...
      {isSettingsMenuOpened ? (
        <div
          className="mt-2 w-48 origin-top rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
          role="menu"
